        ...
        <div className='container'>
            ...
            <div className='links'>
                ...
                <Link className='link' to='/?cat=blogs'><div className='linkDiv' tabIndex="1"  onClick={()=>{
                    setstyle1({color:"lightblue",'font-weight':"800",})
                    setstyle2({color:""})
                    setstyle3({color:""})
                    setstyle4({color:""})
                ...
                <Link className='link' to='/?cat=writes'><div className='linkDiv' tabIndex="2" onClick={()=>{
                    setstyle1({color:""})
                    setstyle2({color:"lightblue",'font-weight':"800"})
                    setstyle3({color:""})
                    setstyle4({color:""})
                ...
                <Link className='link' to='/?cat=readings'><div className='linkDiv' tabIndex="3" onClick={()=>{
                    setstyle1({color:""})
                    setstyle2({color:""})
                    setstyle3({color:"lightblue",'font-weight':"800"})
                    setstyle4({color:""})
                ...
                <Link className='link' to='/?cat=games'><div className='linkDiv' tabIndex="4" onClick={()=>{
                    ...
                    setstyle2({color:""})
                    setstyle3({color:""})
                    setstyle4({color:"lightblue",'font-weight':"800"})
                ...
                <Link className='link' to="/write"><Button size='large' shape="primary" icon={<EditOutlined /> } onClick={()=>{
                    setstyle1({color:""})
                    setstyle2({color:""})
                    setstyle3({color:""})
                    setstyle4({color:""})
